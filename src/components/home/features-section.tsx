...
const featureCards: Array<{
...
}> = [
	{
		...
		body: "Recognizes Malay, English, Mandarin, Tamil, and dialect nuances to keep every conversation clear.",
		content: "multilingual",
	},
	{
		title: "Accurate Speech-to-Text",
		body: "Advanced acoustic modeling delivers precise transcripts even in noisy, real-world environments.",
		content: "stt",
	},
	{
		title: "Cross-Platform Access",
		body: "Seamless deployment across web, mobile, and telephony with unified Suara APIs.",
		content: "access",
	},
	{
		title: "AI-Powered Precision",
		body: "RapidScreen insights continuously tune Suara voice models for faster, smarter responses.",
		content: "ai",
	},
];
...
export function FeaturesSection() {
	return (
		<section
			id="features"
			className="mt-28 flex w-full flex-col items-center px-4"
		>
			<div className="flex w-full max-w-7xl flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
				...
				<p className="max-w-xl text-2xl leading-[1.55] text-[#29282b80] lg:text-right">
					...
					dialects and languages through RapidScreen AI, ensuring accurate voice
					recognition across all communities.
				</p>
			</div>
				...
				{featureCards.map((card) => (
					...
					>
						<div className="relative z-10">
							<h3 className="text-[28px] font-semibold text-[#29282b]">
								{card.title}
							</h3>
							<p className="mt-3 text-xl leading-[1.6] text-[rgba(41,40,43,0.72)]">
								{card.body}
							</p>
						</div>
