	...
	return (
		<footer className="relative mt-28 w-full overflow-hidden bg-white px-4 pb-10 pt-14">
					...
					<div className="w-full">
						...
						<ul className="grid gap-3 text-[rgba(4,9,20,0.70)]">
							{[
								...
								<li key={item.href}>
									<a
										className="transition hover:text-[#0b1323]"
										href={item.href}
									>
										{item.label}
									</a>
			...
			<div className="relative z-10 mx-auto flex w-full max-w-7xl flex-col items-start gap-5 text-[rgba(4,9,20,0.75)] md:flex-row md:items-center md:justify-between">
				...
				<div
					className="inline-flex items-center gap-6 text-sm"
					role="navigation"
					aria-label="Legal"
				>
					<a
						className="border-b border-[rgba(4,9,20,0.18)] pb-[2px] transition hover:border-[rgba(4,9,20,0.36)]"
						href="/terms"
					>
						Terms of Service
					</a>
