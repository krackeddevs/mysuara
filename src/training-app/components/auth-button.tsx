...
function AuthButtonContent() {
  ...
  if (!authenticated) {
    return (
      <button
        onClick={login}
        className="cursor-pointer flex items-center gap-2 bg-background hover:bg-muted rounded-lg transition-all px-3 h-10 text-sm font-medium"
      >
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent
        className="w-56 p-4 mt-2 border border-slate-200 rounded-lg bg-white"
        align="end"
        forceMount
      >
