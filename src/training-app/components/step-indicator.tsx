...
export function StepIndicator({
	...
	const textStatus: StepStatus =
		isAudioComplete || currentStep === "audio"
			? "completed"
			: isOnTextStep
				? "active"
				: "upcoming";
	const audioStatus: StepStatus = isAudioComplete
		? "completed"
		: currentStep === "audio"
			? "active"
			: "upcoming";
	...
	return (
		<div className="mb-8 mt-16 flex items-center justify-center gap-3 lg:mt-0">
			...
			<div
				className={`h-px w-12 rounded-full transition-colors duration-200 ${connectorClass}`}
			/>
