...
const impactMetrics = [
	{
		value: "60+",
		label: "dialects & accents actively represented in our corpora",
	},
	{
		value: "18 pilots",
		label: "live across ministries, enterprises, and NGOs",
	},
			...
			<div className="relative isolate mx-auto flex w-full max-w-7xl flex-col gap-20 px-4 pb-28 pt-24 sm:px-6 lg:px-10">
					...
					<div className="relative flex flex-col gap-14 lg:flex-row lg:items-center lg:justify-between">
						<div className="max-w-xl space-y-7">
							...
							<p className="text-lg leading-relaxed text-[var(--muted)]">
								Suara unites linguists, engineers, and frontline teams to build
								a national voice AI that hears every Malaysian—and keeps
								sovereignty, inclusion, and measurable impact at the centre of
								every deployment.
							</p>
				...
				>
					<header className="mx-auto max-w-3xl space-y-3 text-center">
						...
						<p className="text-base text-[#1d3350b3]">
							Suara protects national data, elevates multi-dialect
							accessibility, and keeps operational control with Malaysian
							partners.
						</p>
					</header>
				...
				>
					<header className="mx-auto max-w-3xl space-y-3 text-center">
						...
						<h2 className="text-[clamp(30px,3vw,44px)] font-semibold text-[var(--ink)]">
							Voice intelligence crafted with every Malaysian in mind.
						</h2>
						<p className="text-base text-[#1d3350b3]">
							From national hotlines to rural clinics, Suara’s coalition keeps
							services personal, contextual, and sovereign.
						</p>
					</header>
					<div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
						{serviceDomains.map((domain) => (
							...
							>
								<div
									className={`pointer-events-none absolute inset-0 bg-gradient-to-br ${domain.accent} opacity-0 transition group-hover:opacity-100`}
									aria-hidden
								/>
								<div
									className={cn(
					...
					<div className="grid gap-12 lg:grid-cols-[0.45fr_0.55fr] lg:items-start">
						<div className="space-y-5">
							...
							<h2 className="text-[clamp(30px,3vw,44px)] font-semibold leading-[1.1] text-[var(--ink)]">
								A five-year path from research corridors to nationwide
								deployments.
							</h2>
							<p className="text-base leading-relaxed text-[#1d3350b3]">
								Our story is shaped by academics, policy shapers, frontline
								agents, and community leaders who demanded a sovereign,
								inclusive approach to voice AI.
							</p>
							<Link
								href="/features"
								...
								>
									<div className="flex flex-col items-center gap-3">
										...
										{index !== foundingTimeline.length - 1 && (
											<span
												className="h-full w-px flex-1 bg-gradient-to-b from-[#2563eb33] via-[#2563eb22] to-transparent"
												aria-hidden
											/>
										)}
									</div>
				...
				>
					<header className="mx-auto max-w-3xl space-y-3 text-center">
						...
						<p className="text-base text-[#1d3350b3]">
							Every Suara engagement is guided by transparent operating
							principles so partners know exactly how intelligence is delivered.
						</p>
					</header>
				...
				>
					<header className="mx-auto max-w-3xl space-y-3 text-center">
						...
						<h2 className="text-[clamp(30px,3vw,44px)] font-semibold text-[var(--ink)]">
							Programmes that keep ministries, enterprises, and communities
							aligned every quarter.
						</h2>
						<p className="text-base text-[#1d3350b3]">
							Structured engagement streams make it simple to co-design, govern,
							and scale nationwide voice automation.
						</p>
					</header>
					...
					<div className="relative flex flex-col items-start gap-8 text-left sm:flex-row sm:items-center sm:justify-between">
						<div className="max-w-xl space-y-4">
							...
							<h2 className="text-[clamp(30px,3.4vw,44px)] font-semibold leading-tight">
								Let’s co-build Malaysia’s next decade of sovereign voice
								automation.
							</h2>
							<p className="text-sm leading-relaxed text-white/80">
								Invite us into your next service initiative, policy sprint, or
								community rollout. Together we’ll deliver voice journeys that
								are inclusive, resilient, and accountable.
							</p>
						</div>
						<div className="flex flex-wrap gap-3">
							<Link
