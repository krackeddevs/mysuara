...
const rights = [
	{
		title: "Access",
		description:
			"Request a copy of data we hold about you at any time. We respond within 30 days or faster when local laws require it.",
	},
	{
		title: "Corrections",
		description:
			"Spot an error? Let us know and we’ll update or annotate your information so it stays accurate and fair.",
	},
	{
		title: "Deletion",
		description:
			"Ask us to remove your records. We erase them unless retention is required for legal, security, or contractual reasons, in which case we’ll explain why.",
	},
	{
		title: "Opt-out",
		description:
			"Withdraw from research pilots, marketing updates, or SMS alerts directly from the message or by contacting our privacy team.",
	},
];
...
function DetailCard({ heading, copy }: { heading: string; copy: string }) {
	return (
			...
			<div className="mx-auto flex w-full max-w-6xl flex-col gap-16 px-4 pb-28 pt-28 sm:px-6 lg:px-10">
				<section className="relative isolate overflow-hidden rounded-3xl bg-gradient-to-br from-[#eaf1ff] via-white to-[#cfddff] px-8 py-20 text-center shadow-[0_32px_96px_rgba(15,23,42,0.12)] sm:px-14">
					<div className="relative mx-auto flex max-w-3xl flex-col gap-5">
						...
						<p className="text-lg leading-relaxed text-[#1f2937]">
							This page summarises how Suara.ai collects, uses, and protects
							information. It complements local regulations and partner
							agreements without replacing them.
						</p>
					</div>
				</section>
				...
				<section className="rounded-3xl bg-white px-6 py-12 shadow-[0_28px_72px_rgba(15,23,42,0.1)] sm:px-12">
					<header className="mx-auto max-w-3xl space-y-3 text-center">
						...
						<p className="text-base leading-relaxed text-[#1f2937]">
							Every privacy decision connects back to these commitments so
							communities can participate with confidence.
						</p>
					</header>
				...
				<section className="rounded-3xl bg-white px-6 py-12 shadow-[0_24px_64px_rgba(15,23,42,0.08)] sm:px-12">
					<header className="mx-auto max-w-3xl space-y-3 text-center">
						...
						<p className="text-base leading-relaxed text-[#1f2937]">
							We limit collection, control access, and keep you informed about
							how information supports national voice AI programmes.
						</p>
					</header>
					<div className="mt-10 grid gap-6 sm:grid-cols-3">
				...
				<section className="rounded-3xl bg-white px-6 py-12 shadow-[0_24px_64px_rgba(15,23,42,0.08)] sm:px-12">
					<header className="mx-auto max-w-3xl space-y-3 text-center">
						...
						<p className="text-base leading-relaxed text-[#1f2937]">
							Whether you’re a citizen participant or an institutional partner,
							we honour standard data protection rights across jurisdictions.
						</p>
					</header>
				...
				<section className="rounded-3xl bg-white px-6 py-12 shadow-[0_24px_64px_rgba(15,23,42,0.08)] sm:px-12">
					<header className="mx-auto max-w-3xl space-y-3 text-center">
						...
						<p className="text-base leading-relaxed text-[#1f2937]">
							We combine policy, technology, and training so sensitive
							information stays protected from collection to deletion.
						</p>
					</header>
					<div className="mt-10 grid gap-6 sm:grid-cols-3">
						{retention.map((item) => (
				...
				<section className="rounded-3xl bg-white px-6 py-12 shadow-[0_24px_64px_rgba(15,23,42,0.08)] sm:px-12">
					<div className="mx-auto grid gap-10 sm:grid-cols-[1.1fr_0.9fr] sm:items-center">
						<div className="space-y-4">
							...
							<p className="text-base leading-relaxed text-[#1f2937]">
								Reach out for privacy requests, partnership compliance checks,
								or general questions about how Suara.ai processes information.
							</p>
						</div>
