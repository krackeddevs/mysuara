...
function SuiteCard({
	...
	return (
		<article className="group relative flex h-full flex-col gap-5 overflow-hidden rounded-[28px] border border-[#2563eb1a] bg-white p-8 shadow-[0_24px_60px_rgba(4,9,20,0.08)] transition hover:-translate-y-1.5 hover:shadow-[0_30px_80px_rgba(4,9,20,0.12)]">
			...
			<p className="relative text-base leading-relaxed text-[#1d3350b3]">
				{description}
			</p>
...
function CapabilityCard({
	...
	return (
		<article className="group relative flex h-full flex-col gap-4 overflow-hidden rounded-[26px] border border-[#2563eb1a] bg-white p-7 shadow-[0_22px_52px_rgba(4,9,20,0.08)] transition hover:-translate-y-1 hover:shadow-[0_28px_64px_rgba(4,9,20,0.12)]">
			...
			<h3 className="relative text-xl font-semibold text-[var(--ink)]">
				{title}
			</h3>
			<p className="relative text-sm leading-relaxed text-[#1d3350b3]">
				{description}
			</p>
		</article>
	);
	...
	return (
		<main className="min-h-[calc(100vh-80px)] w-full bg-[var(--bg)] text-[var(--ink)]">
			<div className="relative isolate mx-auto flex w-full max-w-7xl flex-col gap-20 px-4 pb-28 pt-24 sm:px-6 lg:px-10">
				<AnimatedSection className="relative isolate overflow-hidden rounded-[36px] border border-[#2563eb1a] bg-gradient-to-br from-[#eef3ff] via-white to-[#dbe8ff] px-6 py-16 shadow-[0_32px_88px_rgba(4,9,20,0.14)] sm:px-10 lg:px-16">
					...
					<div className="relative flex flex-col gap-14 lg:flex-row lg:items-center lg:justify-between">
						<div className="max-w-xl space-y-7">
							...
							<p className="text-lg leading-relaxed text-[var(--muted)]">
								Suara unifies speech, sentiment, and service automation so
								federal agencies, enterprises, and communities can collaborate
								through natural voice—securely, inclusively, and at scale.
							</p>
						...
						<div className="relative mx-auto grid w-full max-w-[360px] place-items-center">
							<div
								className="absolute inset-0 rounded-[40px] bg-gradient-to-br from-[#60a5fa33] via-[#1d4ed824] to-[#93c5fd48] blur-3xl"
								aria-hidden
							/>
								...
								<div className="relative flex h-full flex-col gap-6 px-10 py-12 text-center">
									...
									<div className="grid gap-3 text-left text-xs text-[#1d3350b3]">
										...
										<div className="flex items-center justify-between rounded-2xl border border-[#2563eb1f] bg-white/70 px-4 py-3">
											<span className="font-semibold text-[#1d3350]">
												Sabah Telehealth
											</span>
					...
					<div className="relative mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
						{heroStats.map((stat) => (
							...
							>
								<p className="text-[clamp(26px,3vw,34px)] font-semibold text-[#1d4ed8]">
									{stat.value}
								</p>
								<p className="mt-2 text-sm leading-relaxed text-[#1d3350b3]">
									{stat.label}
								</p>
							</article>
						))}
				...
				<AnimatedSection
					delay={0.1}
					className="space-y-10 rounded-[34px] border border-[#2563eb12] bg-white px-6 py-16 shadow-[0_26px_70px_rgba(4,9,20,0.1)] sm:px-10"
				>
					<header className="mx-auto max-w-3xl space-y-3 text-center">
						...
						<h2 className="text-[clamp(30px,3vw,44px)] font-semibold text-[var(--ink)]">
							Modular capabilities that launch fast and scale nationwide.
						</h2>
						<p className="text-base text-[#1d3350b3]">
							Choose the suite that fits your operational reality—each one is
							composable, governed, and tuned to Malaysian workflows.
						</p>
					</header>
				...
				>
					<header className="mx-auto max-w-3xl space-y-3 text-center">
						...
						<h2 className="text-[clamp(30px,3vw,44px)] font-semibold text-[var(--ink)]">
							Every module engineered for inclusive, secure operations.
						</h2>
						<p className="text-base text-[#1d3350b3]">
							From first hello to policy impact, Suara keeps the loop closed
							with culturally fluent AI and human control points.
						</p>
					</header>
					<div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
				...
				<AnimatedSection
					delay={0.26}
					className="relative isolate overflow-hidden rounded-[34px] border border-[#2563eb1a] bg-gradient-to-br from-[#0f172a] via-[#1d2760] to-[#1d4ed8] px-6 py-16 text-white shadow-[0_34px_90px_rgba(9,20,60,0.52)] sm:px-12"
				>
					...
					<div className="relative grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
						<div className="space-y-6">
							...
							<h2 className="text-[clamp(30px,3.2vw,46px)] font-semibold leading-[1.08]">
								Observe, orchestrate, and improve every conversation in real
								time.
							</h2>
							<p className="text-base leading-relaxed text-white/80">
								Command dashboards bring together speech streams, operational
								KPIs, and compliance signals so your teams can coach agents,
								activate playbooks, and demonstrate ROI instantly.
							</p>
							<div className="flex flex-wrap gap-4">
								{opsMetrics.map((metric) => (
									<div
										key={metric.label}
										className="rounded-[26px] border border-white/20 bg-white/10 px-6 py-4 text-left backdrop-blur"
									>
								...
								<div className="mt-6 grid gap-3 text-sm text-white/80">
									<div className="flex items-start justify-between rounded-2xl border border-white/12 bg-white/10 px-4 py-3">
										<div>
											...
											<p className="text-xs text-white/70">
												Reminder sent · Consent disclosure completed
											</p>
										</div>
										<span className="rounded-full bg-white/15 px-3 py-1 text-xs uppercase tracking-[0.24em] text-white/70">
											+12%
										</span>
									</div>
									<div className="flex items-start justify-between rounded-2xl border border-white/12 bg-white/5 px-4 py-3">
										<div>
											...
											<p className="text-xs text-white/70">
												Positive · Mandailing dialect detected
											</p>
										</div>
				...
				<section className="space-y-12 rounded-[34px] border border-[#2563eb12] bg-white px-6 py-16 shadow-[0_26px_70px_rgba(4,9,20,0.1)] sm:px-10">
					<header className="mx-auto max-w-3xl space-y-3 text-center">
						...
						<h2 className="text-[clamp(30px,3vw,44px)] font-semibold text-[var(--ink)]">
							A closed-loop flow that keeps teams aligned from insight to
							action.
						</h2>
						<p className="text-base text-[#1d3350b3]">
							Every step is instrumented with compliance, analytics, and
							collaboration hooks so nothing slips through the cracks.
						</p>
					</header>
					<div className="relative grid gap-6 lg:grid-cols-4">
						{workflowSteps.map((step, index) => (
							...
							>
								...
								<h3 className="mt-8 text-lg font-semibold text-[var(--ink)]">
									{step.label}
								</h3>
								<p className="text-sm leading-relaxed text-[#1d3350b3]">
									{step.detail}
								</p>
								{index !== workflowSteps.length - 1 && (
									<span
										className="absolute right-[-26px] top-1/2 hidden h-[1px] w-16 -translate-y-1/2 bg-gradient-to-r from-[#2563eb33] via-[#2563eb22] to-transparent lg:block"
										aria-hidden
									/>
								)}
							</article>
				...
				<section className="grid gap-12 rounded-[34px] border border-[#2563eb12] bg-white px-6 py-16 shadow-[0_26px_70px_rgba(4,9,20,0.1)] sm:px-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
					<div className="space-y-5">
						...
						<p className="text-base leading-relaxed text-[#1d3350b3]">
							Sovereign-grade security, inclusive data practices, and measurable
							impact come as standard—not as optional upgrades.
						</p>
					</div>
					<div className="grid gap-5">
						{intelligenceLayers.map((layer) => (
							<article
								key={layer.title}
								className="rounded-[26px] border border-[#2563eb1f] bg-[#f8fbff] p-6 shadow-[0_20px_48px_rgba(4,9,20,0.08)]"
							>
						...
						<div className="max-w-3xl space-y-6">
							...
							<div className="flex items-center gap-4">
								...
								<div>
									...
									<p className="text-xs uppercase tracking-[0.28em] text-[#1d3350b3]">
										{testimonial.role}
									</p>
								</div>
							</div>
				...
				<section className="space-y-10 rounded-[34px] border border-[#2563eb12] bg-white px-6 py-16 shadow-[0_26px_70px_rgba(4,9,20,0.1)] sm:px-10">
					<header className="mx-auto max-w-3xl space-y-3 text-center">
						...
						<p className="text-base text-[#1d3350b3]">
							Suara works with local telcos, open-source models, and enterprise
							suites—without compromising sovereignty.
						</p>
					</header>
				...
				<section className="space-y-10 rounded-[34px] border border-[#2563eb12] bg-white px-6 py-16 shadow-[0_26px_70px_rgba(4,9,20,0.1)] sm:px-10">
					<header className="mx-auto max-w-3xl space-y-3 text-center">
						...
						<p className="text-base text-[#1d3350b3]">
							Need deeper answers? Our specialists will walk you through
							deployment, integrations, and governance.
						</p>
					</header>
					<div className="grid gap-6 sm:grid-cols-2">
						{faqs.map((item) => (
							...
							>
								...
								<p className="mt-3 text-sm leading-relaxed text-[#1d3350b3]">
									{item.answer}
								</p>
							</article>
						))}
					...
					<div className="relative flex flex-col items-start gap-8 text-left sm:flex-row sm:items-center sm:justify-between">
						<div className="max-w-xl space-y-4">
							...
							<p className="text-sm leading-relaxed text-white/80">
								Our team embeds with yours to deliver sovereign, inclusive, and
								high-performing voice journeys—backed by RapidScreen data loops
